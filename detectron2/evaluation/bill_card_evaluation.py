...
class BillCardDetectionEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        # 各个类别的AP:
        self._logger.info("train_ticket:")
        self._logger.info("AP50:{}".format(aps[50][0])+"AP75:{}".format(aps[75][0])+"AP:")
        self._logger.info("bank_card:")
        self._logger.info("AP50:{}".format(aps[50][1])+"AP75:{}".format(aps[75][1])+"AP:")
        self._logger.info("bill_card:")
        self._logger.info("AP50:{}".format(aps[50][2])+"AP75:{}".format(aps[75][2])+"AP:")
        # print("train_ticket:")
